...
type SortKey = "updatedAt" | "joinedAt" | "name";
...
export default function SharedPage() {
  ...
  useEffect(() => {
    if (session?.user) {
      Promise.all([
        fetch("/api/projects/shared").then((r) => r.json()),
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [sharedProjects, search, sortKey, sortDir]);

  if (!session) return null;

  const isEmpty = !loading && sharedProjects.length === 0;
        ...
        <div className="relative flex min-w-0 flex-1 flex-col overflow-hidden rounded-2xl bg-[#141418]">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8 md:px-10">
            ...
            {loading ? (
              ...
              /* Empty state — animated visual mockup */
                ...
                <div className="relative mb-10 h-56 w-80">
                  ...
                  >
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <div className="h-4 w-4 rounded-full bg-pink-600/40" />
                      <div>
                  ...
                  {/* Card 2 — center front, featured with avatars */}
                  <div
                  ...
                  >
                    ...
                    <div className="mt-2.5 flex items-center justify-between">
                      ...
                      {/* Stacked avatar indicator */}
                      <div className="flex -space-x-1.5">
                        <div
                          className="h-4 w-4 rounded-full bg-orange-500 ring-1 ring-black/30"
                          style={{
                            animation: "logoPulse 2s ease-in-out infinite",
                          }}
                        />
                        <div
                          className="h-4 w-4 rounded-full bg-blue-500 ring-1 ring-black/30"
                          style={{
                            animation:
                              "logoPulse 2s ease-in-out infinite 0.3s",
                          }}
                        />
                      </div>
                    </div>
                  ...
                  >
                    <div className="h-16 rounded-lg bg-gradient-to-br from-[#1e1e2e] to-[#2a2a3a]" />
                    <div className="mt-2 flex items-center gap-2">
                      <div className="h-4 w-4 rounded-full bg-green-600/40" />
                      <div>
                  ...
                  <div
                    className="absolute left-12 top-2 text-violet-400/30"
                    style={{ animation: "bounce 2s ease-in-out infinite" }}
                  >
                    <Users className="h-3 w-3" />
                  </div>
                  <div
                    className="absolute right-14 top-0 text-violet-400/20"
                    style={{
                  ...
                  <div
                    className="absolute bottom-10 left-8 text-violet-400/15"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 pt-2.5">
                      {project.ownerImage ? (
                        ...
                        <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-600 text-[9px] font-bold text-white">
                        ...
                        <td className="hidden px-3 py-3 sm:table-cell">
                          <div className="flex items-center gap-2">
                            {project.ownerImage ? (
                              ...
                              <div className="flex h-5 w-5 items-center justify-center rounded-full bg-violet-600 text-[9px] font-bold text-white">
                                {(project.ownerName || "U")
                                  .charAt(0)
                                  .toUpperCase()}
                              </div>
