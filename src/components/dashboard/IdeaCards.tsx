...
const DEFAULT_IDEAS: AppIdea[] = [
  {
    ...
    translationKey: "saasLandingPage",
    prompt:
  ...
  },
  {
    ...
    translationKey: "portfolioWebsite",
    prompt:
      ...
      <div className="flex justify-center gap-2">
        {loading
          ...
          : ideas.map((idea, i) => (
              ...
              >
                {idea.translationKey ? t(idea.translationKey) : idea.title}
              </button>
            ))}
      </div>
      <button
